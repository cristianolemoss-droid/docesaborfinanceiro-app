...
export const mapInventoryToDb = (item: InventoryItem) => ({
  ...
  data_fabricacao: (item.dataFabricacao && item.dataFabricacao.trim() !== '') ? item.dataFabricacao : '1970-01-01',
  data_validade: (item.dataValidade && item.dataValidade.trim() !== '') ? item.dataValidade : '9999-12-31',
